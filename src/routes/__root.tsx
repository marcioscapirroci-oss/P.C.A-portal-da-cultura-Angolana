...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PCArt — Plataforma da Cultura Angolana — Jornalismo, Cultura e Música de Angola" },
      ...
      { name: "twitter:title", content: "PCArt — Plataforma da Cultura Angolana — Jornalismo, Cultura e Música de Angola" },
